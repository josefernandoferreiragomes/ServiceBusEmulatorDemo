...
public class FunctionTopic1Subscription2DeadLetter
{
    private const string topicName = "topic.1";
    private readonly ILogger<FunctionTopic1Subscription2DeadLetter> _logger;
    ...
    public FunctionTopic1Subscription2DeadLetter(ILogger<FunctionTopic1Subscription2DeadLetter> logger)
    {
        _logger = logger;
    }

    [Function(nameof(FunctionTopic1Subscription2DeadLetter))]
    public async Task Run(
        [ServiceBusTrigger(topicName, "subscription.2/$DeadLetterQueue", Connection = "SERVICEBUS_CONNECTION_STRING")]
